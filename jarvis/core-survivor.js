...
const seq128={IDLE:[0,1,0,2],STEP:[1,2,3,2],DASH:[2,3,2,1],GUARD:[4,0,4,1],JAB:[0,5,6,1],CROSS:[1,6,5,0],KICK:[2,7,6,1],SPIN:[3,7,2,0],BEAM:[4,5,6,4],HIT:[7,4,0,1],RECOVER:[7,2,1,0]};
...
production128.ready=true;combatEvent('PRODUCTION_128_READY',{formArt:'CINEMATIC ONLY',gameplay:'ANIMATED SAFE-CELL RIG',poses:Object.keys(seq128).length,scale:'MOBILE +17 PERCENT',shadows:'ACTOR-CONTACT',enemies:'SEEDED POSE AND FOOTWORK VARIATION'});
