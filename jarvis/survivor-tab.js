(()=>{'use strict';
const H='survivor',SRC='survivor.html?v=20260819scratch300sprites1';let observer,timer;
if(!document.querySelector('link[data-survivor-style]')){const link=document.createElement('link');link.rel='stylesheet';link.href='jarvis/survivor-tab.css?v=20260819scratch300sprites1';link.dataset.survivorStyle='1';document.head.append(link)}
...
function mount(){
 ...
 document.getElementById('workspaceDescription').textContent='Griffin climbs a nine-round ascension tournament through one canonical sprite-driven Survivor runtime.';
 ...
 const frame=body.querySelector('.survivor-frame');if(frame?.src.includes('20260819scratch300sprites1'))return;
 body.innerHTML=`<section class="survivor-card"><div class="survivor-load">Initializing Core Survivor sprites…</div><iframe class="survivor-frame" src="${SRC}" title="Jarvis Core Survivor" allow="autoplay; fullscreen" loading="eager"></iframe></section>`;
