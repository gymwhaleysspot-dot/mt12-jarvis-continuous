(()=>{'use strict';
const H='survivor',GRAPHICS_VERSION=3,CACHE='20260819scratch300graphics3',SRC=`survivor.html?v=${CACHE}`;let observer,timer;
...
.clock{border-color:color-mix(in srgb,var(--stageAccent) 58%,transparent)!important;box-shadow:0 0 22px color-mix(in srgb,var(--stageAccent) 18%,transparent),inset 0 1px rgba(255,255,255,.08)}
.bars{gap:12px!important}.bar{height:9px!important;border-color:rgba(255,255,255,.19)!important;background:rgba(0,0,0,.58)!important;box-shadow:inset 0 1px 4px #000,0 1px rgba(255,255,255,.05)}.bar i{box-shadow:0 0 12px currentColor;transition:width .12s linear}.meter{height:5px!important;margin-top:4px!important}.caption{border-color:color-mix(in srgb,var(--stageAccent) 55%,transparent)!important;border-left-color:var(--stageAccent)!important}.caption.show{transform:translateX(-50%) translateY(-3px);box-shadow:0 12px 34px #0009,0 0 24px color-mix(in srgb,var(--stageAccent) 18%,transparent)}
