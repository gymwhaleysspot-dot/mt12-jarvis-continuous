...
const wheelMat=m=>near(m,[.006,.007,.009])||near(m,[.018,.020,.024])||near(m,[.43,.50,.59])||near(m,[.10,.13,.17])||near(m,[.24,.26,.29]);
const shadowMat=m=>near(m,[.001,.001,.002]);
