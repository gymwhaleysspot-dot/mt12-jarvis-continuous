...
import {JarvisXRRenderer} from './michael-graphics-v40.js?v=michael84';
...
let polyglot=null;bootMichaelPolyglot('./generated/','michael84').then(api=>{polyglot=api;globalThis.__MICHAEL_POLYGLOT=api}).catch(error=>console.warn('MICHAEL V57 optional module fallback',error));
...
const fallback='https://gymwhaleysspot-dot.github.io/mt12-jarvis-continuous/assets/mjx7303/mjx7303-v33.glb?v=michael84-fallback';
