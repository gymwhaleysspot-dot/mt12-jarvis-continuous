...
class MichaelFeaturePolicy{
  constructor(){this.tier='ULTRA';this.features={clearcoat:true,transmission:true,softShadows:true,layeredForest:true,reflections:true,particles:true};this.ema=16.7}
