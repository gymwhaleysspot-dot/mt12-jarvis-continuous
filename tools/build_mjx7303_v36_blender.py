...
S=bpy.context.scene;try:S.render.engine='BLENDER_EEVEE_NEXT'\nexcept TypeError:S.render.engine='BLENDER_EEVEE'S.render.resolution_x=1100;S.render.resolution_y=825;S.render.resolution_percentage=100
