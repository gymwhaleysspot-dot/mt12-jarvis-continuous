...
const required = [
  ...
  'LIMIT_BREAK_ANIME_2_5D_V10', "schema:'jarvis-survivor-replay-v19'",
...
console.log(JSON.stringify({runtime:323,replay:'v19',frames:'10Hz + transitions',combo:'confirmed hits',finisher:'lethal completion',renderer:'LIMIT_BREAK_ANIME_2_5D_V10',result:'PASS'}));
