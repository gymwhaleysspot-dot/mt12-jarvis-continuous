...
html=html.replace(script,'jarvis/core-survivor.js?v=20260816production198');
fs.writeFileSync(htmlPath,html);
console.log({built:layers.map(x=>x.marker),bytes:source.length,cache:'production198'});
