...
bpy.ops.import_scene.obj(filepath=SCAN,axis_forward='-Z',axis_up='Y')
...
S.world.color=(.011,.014,.020);S.render.engine='BLENDER_EEVEE';S.render.resolution_x=1400;S.render.resolution_y=1050;S.render.resolution_percentage=100;S.render.image_settings.file_format='PNG';S.render.film_transparent=False
