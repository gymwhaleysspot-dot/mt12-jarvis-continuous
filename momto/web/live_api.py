...
from ..service import case_summary,workspace_report,ranked_next_actions,live_activity,search_ai_cycle
router=APIRouter()
...
def momto_live():
 ...
 return {"case":{"status":s["status"]},"objectives":{k:{"status":v} for k,v in s["objectives"]},
  ...
  "advanced":{**s["advanced"],"workspace":workspace_report()["coverage"]},"next_actions":ranked_next_actions(),"activity":live_activity(25),"search_ai":search_ai_cycle(20)}
