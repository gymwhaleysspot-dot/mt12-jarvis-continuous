...
from ..service import case_summary,workspace_report,ranked_next_actions
router=APIRouter()
...
def momto_live():
 ...
 return {"case":{"status":s["status"]},"objectives":{k:{"status":v} for k,v in s["objectives"]},
  ...
  "advanced":{**s["advanced"],"workspace":workspace_report()["coverage"]},"next_actions":ranked_next_actions()}
