(()=>{
  'use strict';
  const pages=[['Home','index.html'],['Aegis','chief.html'],['Drive Builds','builds.html'],['Missions','mission.html'],['Completion','completion.html'],['Device','device.html'],['Control','control.html'],['Research','research.html'],['Discovery','discovery.html'],['OS v3','v3.html'],['Updates','updates.html'],['Builder Lite','builder.html']];
