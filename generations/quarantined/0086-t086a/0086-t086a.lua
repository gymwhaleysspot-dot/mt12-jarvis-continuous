-- factory full-AI cycle 86; tuesday; gen 86; parent 0076-w076a.lua; objective traction, ABS and intervention quality
...
local POLE=2;local RPM2MPH=0.000932068;local WB=0.375;local MAX_STEER=26
local SURF={
...
local function nt(t1, t2, t3) local o1, o2, o3 = nf(N[6], N[7], N[8], N[9], N[10], N[11])
    local e1, e2, e3 = t1 - o1, t2 - o2, t3 - o3
    local lr = 0.001 + 0.003 * (1 - N[3])
    
    N[17] = e1 * ((o1 > 0 and o1 < 1) and 0.4 or 0)
    N[18] = e2 * ((o2 > 0 and o2 < 1) and 0.4 or 0)
    N[19] = e3 * ((o3 > 0 and o3 < 1) and 0.4 or 0)
    ...
    for j = 1, 4 do
        ...
        de = de * ((h > 0 and h < 1) and 0.4 or 0)
        local q = (j - 1) * 6 + 1
        for i = 0, 5 do
