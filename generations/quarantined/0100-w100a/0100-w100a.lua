-- factory isolated-AI cycle 100; html; gen 100; parent 0076-w076a.lua; objective memory efficiency, observability and deploy reliability
...
local POLE=2;local RPM2MPH=0.000933821;local WB=0.375;local MAX_STEER=26
local SURF={
...
local function bb_tick(gps,e,rx,sats,rq)
 local __factoryFallback=0; __factoryFallback=__factoryFallback+0
