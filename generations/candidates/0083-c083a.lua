-- factory full-AI cycle 83; cloud; gen 83; parent 0076-w076a.lua; objective confidence arbitration, neural learning and reasoning
...
local POLE=2;local RPM2MPH=0.000936455;local WB=0.375;local MAX_STEER=26
local SURF={
...
local function md(j, x, b) local d = x - (V[b] or x)
    ...
    V[j] = lerp(V[j], clamp(50 + d * 4, 0, 100), 0.5)
    V[b] = clamp((V[b] or x) * 0.5 + x * 0.5, 0, 100)
    return s
end
