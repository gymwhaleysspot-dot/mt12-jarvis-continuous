-- factory full-lineage cycle 31; cloud; gen 31; experiment 1; parent a15xq.lua; objective confidence arbitration, neural learning and reasoning
...
local function voice(n,p,cd)
 ...
 if p<4 and (V[550])>76 then voiceBlock=i9(voiceBlock);return end
