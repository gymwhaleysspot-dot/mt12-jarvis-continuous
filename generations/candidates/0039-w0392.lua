-- factory full-lineage cycle 39; html; gen 39; experiment 2; parent a15xq.lua; objective memory efficiency, observability and deploy reliability
...
local function voice(n,p,cd)
 ...
 if p<5 and vLoad>78 then voiceBlock=i9(voiceBlock);return end
