-- factory full-lineage cycle 42; html; gen 42; experiment 3; parent 0040-c0403.lua; objective memory efficiency, observability and deploy reliability
...
local sR=0;local cL=0;local srt=55;local clt=30;local sndCd=0;local sndPr=0;local sndLast=0;local metaLast=0;local vcCd=0;local vcLast=0;local vcCnt=0;local vcPr=0;local vBoot=1;local vWait=107;local vLoad=0;local vQuiet=50;local voiceBlock=0;local sndBlock=0
