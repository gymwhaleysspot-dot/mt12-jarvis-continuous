-- factory full-AI cycle 71; html; gen 71; parent 0070-t070a.lua; objective memory efficiency, observability and deploy reliability
...
local POLE=2;local RPM2MPH=0.000924335;local WB=0.375;local MAX_STEER=26
local SURF={
...
local function md(j,x,b) local d=x-(V[b]or x)
 ...
 V[j]=trait(V[j],clamp(50+d*5,0,99),.4)
 V[b]=clamp((V[b]or x)*.6+x*.4,0,99)
 return s 
end
