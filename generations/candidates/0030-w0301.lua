-- factory full-lineage cycle 30; html; gen 30; experiment 1; parent a15xq.lua; objective memory efficiency, observability and deploy reliability
...
local function voice(n,p,cd)
 ...
 if p<4 and (V[550])>81 then voiceBlock=i9(voiceBlock);return end
