-- factory full-lineage cycle 39; html; gen 39; experiment 3; parent a15xq.lua; objective memory efficiency, observability and deploy reliability
...
local function voice(n,p,cd)
 ...
 if p<4 and (V[550])>69 then voiceBlock=i9(voiceBlock);return end
