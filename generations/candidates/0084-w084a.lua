-- factory full-AI cycle 84; html; gen 84; parent 0076-w076a.lua; objective memory efficiency, observability and deploy reliability
...
local POLE=2;local RPM2MPH=0.000932127;local WB=0.375;local MAX_STEER=26
local SURF={
...
local function voiceTick() if vcCd > 0 then vcCd = vcCd - 1; if vcCd == 0 then vcPr = 0 end end
 vLoad = clamp(vLoad * 0.95, 0, 99)
 vQuiet = clamp(50 + vLoad * 0.5 + (V[550]) * 0.15 + (V[386]) * 0.05, 50, 99)
 if vWait > 0 then vWait = vWait - 1; return end
 if vBoot == 1 then voice(90, 5, 115); vBoot = 2; vWait = 40
 elseif vBoot == 2 then voice((memLoaded > 0) and 92 or 91, 5, 115); vBoot = 3; vWait = 34
 elseif vBoot == 3 then if memLoaded > 0 and V[376] > 0 then voice(93, 5, 95); pcall(playNumber, V[376], 0) else voice(94, 5, 95) end; vBoot = 4; vWait = 16
 elseif vBoot == 4 then voice(30, 5, 100); vBoot = 5; vWait = 18
 elseif vBoot == 5 then voice(95, 5, 140); vBoot = 0 end
end
