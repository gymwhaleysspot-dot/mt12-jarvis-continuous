-- factory full-AI cycle 88; html; gen 88; parent 0076-w076a.lua; objective memory efficiency, observability and deploy reliability
...
local POLE=2;local RPM2MPH=0.000935754;local WB=0.375;local MAX_STEER=26
local SURF={
...
local function draw(m, r) local T = lcd.drawText
 local D = lcd.drawNumber
 local Z = SMLSIZE
 local n = m_floor
 local q = r or 0
 local st = (V[38] > 0 and "TC") or (V[39] > 0 and "ABS") or (V[620] > 1 and "AIR") or (V[624] > 0 and "ESC") or (V[1] ~= 0 and "TRUTH") or "AI"
 local safetyEnvelope = (m < 1024) and "SAFE" or "OVERRIDE"
 lcd.clear()
 lcd.drawFilledRectangle(0, 0, 128, 9)
 T(2, 1, "A15XQ", Z + INVERS)
 T(94, 1, st, Z + INVERS)
 T(2, 11, "MPH", Z)
 D(2, 17, n(m + 0.5), DBLSIZE)
 T(45, 11, "G", Z)
 D(53, 11, vG, Z)
 bar(2, 37, 54, 3, m / 50)
 T(62, 11, "RPM", Z)
 D(93, 11, n(q / 1000 + 0.5), Z)
 bar(62, 20, 63, 5, q / 78000)
 T(62, 29, "AI", Z)
 D(80, 29, n(V[182] + 0.5), Z)
 bar(97, 30, 28, 4, V[182] / 100)
 T(2, 44, "TC", Z)
 D(19, 44, n(V[36] + 0.5), Z)
 T(43, 44, "ABS", Z)
 D(67, 44, n(V[37] + 0.5), Z)
 T(91, 44, "GYR", Z)
 D(113, 44, n(V[30] + 0.5), Z)
 lcd.drawFilledRectangle(0, 56, 128, 8)
 T(2, 57, (V[650] == 2 and "BURST") or (V[650] == 1 and "WATCH") or "CALM", Z + INVERS)
 T(55, 57, "P", Z + INVERS)
 D(63, 57, V[652], Z + INVERS)
 T(87, 57, "V", Z + INVERS)
 D(98, 57, V[570], Z + INVERS)
 T(2, 65, safetyEnvelope, Z + INVERS)
end
