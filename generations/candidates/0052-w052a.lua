-- factory full-AI cycle 52; html; gen 52; parent 0042-m0422.lua; objective memory efficiency, observability and deploy reliability
...
local POLE=2;local RPM2MPH=0.000921067;local WB=0.375;local MAX_STEER=26
local SURF={
