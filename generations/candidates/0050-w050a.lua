-- factory full-AI cycle 50; html; gen 50; parent 0042-m0422.lua; objective memory efficiency, observability and deploy reliability
...
local POLE=2;local RPM2MPH=0.000914065;local WB=0.375;local MAX_STEER=26
local SURF={
