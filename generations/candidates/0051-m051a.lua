-- factory full-AI cycle 51; monday; gen 51; parent 0042-m0422.lua; objective truth prediction, calibration and sensor resilience
...
local POLE=2;local RPM2MPH=0.000914984;local WB=0.375;local MAX_STEER=26
local SURF={
