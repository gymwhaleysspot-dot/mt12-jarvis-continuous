...
local ok,m=pcall(dofile,"/home/runner/work/mt12-jarvis-continuous/mt12-jarvis-continuous/generations/candidates/0091-c091a.lua");if not ok then error('load:'..tostring(m))end
