...
local ok,m=pcall(dofile,"/home/runner/work/mt12-jarvis-continuous/mt12-jarvis-continuous/generations/candidates/0090-t090a.lua");if not ok then error('load:'..tostring(m))end
